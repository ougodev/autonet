        ...
        <div className="footer__bottom">
          <div className="footer__developer">
            ...
            <div className="developer-info">
              <span className="developer-credit">{t('footer.developedBy')}</span>
              <div className="developer-links">
                <a href="https://github.com/oussamagobji" target="_blank" rel="noopener noreferrer" className="social-link">
                ...
                <a href="https://www.linkedin.com/in/oussamagobji/" target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
          ...
          <p className="footer__copyright">&copy; {currentYear} {t('footer.copyright')}</p>
        </div>
      </div>
    </footer>
  );
